...
//얕은 복사 : 각각 다른 배열을 합칠 때 배열의 값이 변해버림
...
//깊은 복사 : 각각 다른 배열을 합칠 때 배열의 값은 변하지 않고 합침
// let arr1 = ["list1", "list2"];
// let arr2 = ["lisst3", "list4"];
// let arr = arr1.concat(arr2);
// console.log(arr);
// console.log(arr1);

//1.초기 상태 정의 (useState 비구조할당 정의)
//2.반복 태그 출력
//3.input 초기 상태 정의
//4.input 태그 입력 시 상태 변화 함수 정의
//5.input 태그 입력 시 콘솔창 확인 함수 정의
//6.add button 초기 상태 정의
//7.add button 클릭 시 항목 추가 함수 정의
//8.항목 더블 클릭 시 해당 항목 삭제 함수 정의(filter함수 사용)
//9.삭제 함수 태그(li)에 적용
